...
class _FilterFilmView extends StatelessWidget{
  ...
  class _FilterFilmContent extends StatelessWidget {
    const _FilterFilmContent();

    @override
    Widget build(BuildContext context) {
      final filterFilmBloc = context.read<FilterFilmBloc>();
      final state = filterFilmBloc.state as FiltersLoaded;
                    ...
                    return InkWell(
                      onTap: () async {
                        ...
                        final result = await context.router.push<dynamic>(
                            ...
                            filterFilmBloc.add(UpdateFilterValue(filterType: filterType, value: result));
                        },
                      child: Container(
                        height: 48.h,
          ...
          ElevatedButton(
            ...
            onPressed: () {
              context.router.push(SearchedFilmsRoute(
                  ...
                  yearFrom: state.yearRange?.$1,
                  yearTo: state.yearRange?.$2,
