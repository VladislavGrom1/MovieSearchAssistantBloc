...
class PersonsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PersonByNameResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PersonByNameResponse>> apiV1PersonsGet({
    ...
    PersonByNameResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PersonByNameResponse),
            ) as PersonByNameResponse;
    ...
    return Response<PersonByNameResponse>(
      data: _responseData,
