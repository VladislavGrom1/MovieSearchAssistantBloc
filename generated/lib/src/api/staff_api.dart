...
class StaffApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<StaffResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<StaffResponse>>> apiV1StaffGet({
    required int filmId,
    ...
    final _queryParameters = <String, dynamic>{
      r'filmId':
          encodeQueryParameter(_serializers, filmId, const FullType(int)),
    };
    ...
    BuiltList<StaffResponse>? _responseData;
    ...
    return Response<BuiltList<StaffResponse>>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PersonResponse>> apiV1StaffIdGet({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/staff/{id}'.replaceAll('{' r'id' '}',
