...
class ApiKeysApi {
  ...
  Future<Response<ApiKeyResponse>> apiV1ApiKeysApiKeyGet({
    ...
    final _path = r'/api/v1/api_keys/{apiKey}'.replaceAll(
        '{' r'apiKey' '}',
        encodeQueryParameter(_serializers, apiKey, const FullType(String))
            .toString());
